                ...
                <div class="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
                    <div class="pattern-dots-md gray-light">
                        <div class="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6  "  >
                            ...
                            <div class="flex-grow ">
                                <h2 class=" text-xl title-font font-medium mb-3">Web Design</h2>
                                <p class="leading-relaxed text-sm text-justify">
                                    Give taste 😍 color to applications, I do it to make your sites attractive 🎨. Before becoming a web designer, I was already familiar with color and drawing from a young age.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-10 md:w-1/3 md:mb-0 mb-6 flex flex-col ">
                    <div class="pattern-dots-md gray-light">
                        <div class="rounded bg-gray-800 p-4 transform translate-x-6 -translate-y-6 ">
                            ...
                            <div class="flex-grow">
                                <h2 class=" text-xl title-font font-medium mb-3">Tech Lead</h2>
                                <p class="leading-relaxed text-sm text-justify">
                                    Placeholder text for tech lead
                                </p>
                            </div>
                        </div>
                    </div>
