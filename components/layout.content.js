...
const Content = () => {
    return <div>
        ...
        <Divider />
        <Hobbies />
        <svg fill="currentColor" viewBox="0 0 1695 57" class="text-green-500"><path d="M0 23c135.4 19 289.6 28.5 462.5 28.5C721.9 51.5 936.7 1 1212.2 1c183.6-.1 344.5 7.3 482.8 22v34H0V23z"></path></svg>
    </div>
}
